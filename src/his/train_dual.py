...
def parse_args():
    ...
    parser.add_argument("--save_dir", type=str, default="checkpoints/real/dual_flow", help="模型保存目录")
    ...
    parser.add_argument("--target_metric", type=float, default=4.3, help="目标指标阈值，总体指标低于该值时停止训练循环")
    parser.add_argument("--max_attempts", type=int, default=1, help="最大尝试次数，为0则无限循环直到达到目标指标")
